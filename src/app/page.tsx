  ...
  const confirmDelete = async () => {
    ...
    if (pendingDelete.type === "course") {
      ...
      await deleteSubmodule(
        pendingDelete.missionId,
        pendingDelete.moduleId,
        pendingDelete.submoduleId,
      );
    }
    ...
    <main className="page dashboard-page">
      ...
      <section className="summary-grid">
        ...
        <div className="summary-card">
          ...
          <span className="summary-detail">
            {dashboard.done}/{dashboard.total} modules
          </span>
        </div>
        <div className="summary-card">
          ...
          <span className="summary-detail">
            {formatTime(dashboard.remainingMinutes)} left
          </span>
        </div>
      </section>
      ...
      {courses.length === 0 ? (
        <section className="empty-state">
          ...
          <p className="empty-hint">
            Create your first course to start adding missions.
          </p>
        </section>
      ) : (
                ...
                return (
                  ...
                  >
                    <span className="course-list-title">
                      {course.title}
                      {finished && (
                        <span className="finished-pill">Finished</span>
                      )}
                    </span>
            ...
            <section className="course-detail">
              <div className="course-detail-header">
                <div>
                  <div className="course-title-row">
                    ...
                    {isCourseFinished(activeCourse) && (
                      <span className="finished-pill">Finished</span>
                    )}
                  </div>
                  <p>
                    {activeCourse.missions.length} missions /{" "}
                    {getCourseStats(activeCourse).total} modules
                  </p>
                </div>
              ...
              <div className="course-progress-block">
                <div className="overall-row">
                  ...
                  <span className="overall-pct">
                    {getCourseStats(activeCourse).pct}%
                  </span>
                </div>
              ...
              {activeCourse.missions.length === 0 ? (
                <div className="empty-state small-empty">
                  <p>No missions yet</p>
                  <p className="empty-hint">
                    Add a mission, then add modules inside it.
                  </p>
                </div>
              ) : (
